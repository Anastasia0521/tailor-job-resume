...
def render(data, photo):
    ...
    for section in data.get("sections", []):
        ...
        for item in section.get("items", []):
            ...
            items.append(f'<article>{heading}{detail_html}<p>{esc(body)}</p></article>')
